...
contract Comptroller is Ownable {
    ...
    function depositERC20(
        ...
        require(
            poolTokenData.token.transferFrom(
                msg.sender,
                address(this),
                _amount
            ),
    ...
    function withdrawERC20(string calldata _poolName, uint256 _amount)
        external
    {
        Datatypes.Pool memory tokenSymbol =
            PrivatePools(privatePoolsContract).poolNames[_poolName].symbol;
        ...
        (uint256 withdrawalAmount, bool penalty) =
